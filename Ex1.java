/*Определить одномерный массив и заполнить его случайными значениями. Определить
допонительный массив, состоящий из повторяющихся элементов исходного массива и вывести его на экран.*/
public class Ex1 {
